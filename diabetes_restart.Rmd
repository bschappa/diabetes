...
deplete the dataset drastically. One-hot encoding will be the better
...
mbm <- microbenchmark(
  #glm models
  "glm_model_median" = {glm_model_median <- train(
=======
mbm <- microbenchmark("glm_model_median" = {glm_model_median <- train(
>>>>>>> 2414d97447e3a142ff2267179f027eeebf2ecbaa
  PAID_high_risk ~ .,
  data = diabetes_train,
  metric = "ROC",
  method = "glm",
...
"glm_model_nzv_median" = {glm_model_nzv_median <- train(
=======
)}
)
...
```{r Real World Validation, eval=FALSE, include=FALSE}
